    ...
    <>
      ...
      <section className='bg-[#FAFAFA] flex flex-col items-center'>
        <div className='grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-4 w-full'>
          <Image
            alt=''
            className='w-full h-full sm:col-span-2 sm:row-span-2'
            src='/products/unsplash_Lks7vei-eAg.png'
            width={100}
            height={100}
            priority
          />
          <Image
            ...
            src='/products/unsplash_1-aA2Fadydc.png'
            width={100}
            height={100}
            priority
          />
          <Image
            alt=''
            className='w-full h-full'
            src='/products/unsplash_gMsnXqILjp4.png'
            width={100}
            height={100}
            priority
          />
          <Image
            alt=''
            className='w-full h-full'
            src='/products/unsplash_mcSDtbWXUZU.png'
            width={100}
            height={100}
            priority
          />
          <Image
            alt=''
            className='w-full h-full'
            src='/products/unsplash_PSmDDeXaEWE.png'
            width={100}
            height={100}
            priority
          />
      ...
      <section className='flex flex-col items-center  py-28'>
        <h2 className='text-3xl md:text-5xl font-bold text-center mb-7'>
        ...
        <a
          className='bg-primary text-white py-2 px-6 text-center rounded rounded-lg mb-7'
          href='#'
        >
          Try it now
        </a>
